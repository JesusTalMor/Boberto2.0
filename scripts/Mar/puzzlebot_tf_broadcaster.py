...
class PuzzlebotTfClass():  
    def __init__(self):  
        ...
        while not rospy.is_shutdown(): 
            ...
            delta = 0.02
            self.pos_wr = self.pos_wr + (self.wr*delta)
            self.pos_wl = self.pos_wl + (self.wl*delta)
            self.send_wr_tf()
            self.send_wl_tf()
    ...
    def send_wr_tf(self):
        ...
        t.transform.translation.z = 0.0 
        quat = quaternion_from_euler(0,self.pos_wl,0)
        t.transform.rotation.x = quat[0] 
        t.transform.rotation.y = quat[1] 
        t.transform.rotation.z = quat[2] 
        t.transform.rotation.w = quat[3] 
    ...
    def send_wl_tf(self):
        ...
        t.transform.translation.y = 0.09
        t.transform.translation.z = 0.0 
        quat = quaternion_from_euler(0,self.pos_wr,0)
        t.transform.rotation.x = quat[0] 
        t.transform.rotation.y = quat[1] 
        t.transform.rotation.z = quat[2] 
        t.transform.rotation.w = quat[3] 

        ...
        while not rospy.is_shutdown():  
            ...
            if self.lidar_received: 
                ...
                if self.at_goal(): 
                    ...
                    if False: #ADD output condition#: we requeired modificstions, cuando deja de seguir la pared cambia comportaminento entre bug 0 y bug 2
